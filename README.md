# jQuery File Upload Plugin (PHP Implementation)

## Demo
[Demo File Upload](http://sutlej.net/clients/dan/jquery-upload/)

## Description
File Upload widget with multiple file selection, drag&amp;drop support, progress bars, validation and preview images, audio and video for jQuery.  
Supports cross-domain, chunked and resumable file uploads and client-side image resizing. Works with PHP and supports standard HTML form file uploads.
...
## Donations
jQuery File Upload is free software, but you can Hire Mansoor Rana to Do Its Implementation:
